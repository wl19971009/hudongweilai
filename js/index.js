        ...
        afterLoad: function (anchorLink, index) {
            ...
            if (index == 3) {
                if (screenWidth <= 768) {
                    ...
                    $(".top-top .right span").text("全网技术平台开发");
                    $('.text_t').animate({marginLeft: "0", opacity: 1}, divAnimationTime);
                    $('.list_box').animate({right: "0", opacity: 1}, divAnimationTime);
                }
            ...
            if (index == 7) {
                if (screenWidth <= 768) {
                    ...
                    $('.right_box').animate({right: "50px", opacity: 1}, divAnimationTime);
                }
        ...
        onLeave: function (index) {
            ...
            if (index == 3) {
                if (screenWidth >= 1200) {
                    ...
                    $('.text_t').animate({marginLeft: "-50px", opacity: 0}, divAnimationTime);
                    $('.list_box').animate({right: "-50%", opacity: 0}, divAnimationTime);
                }
            }
            if (index == 4) {
                if (screenWidth >= 1200) {
            ...
            if (index == 7) {
                if (screenWidth >= 1200) {
                    ...
                    $('.right_box').animate({right:"-5%",opacity: 0}, divAnimationTime);
 ...
 var index=window.location.href.split("/").length-1;
    ...
    $(function(){
        ...
        function moveL(){
            ...
            $(".out .numli").eq(i).addClass("active").siblings().removeClass("active");
            $(".out .img li").eq(i).fadeIn(300).siblings().fadeOut(300);
        }
        //核心向右运动函数
        function move(){
            i++;
